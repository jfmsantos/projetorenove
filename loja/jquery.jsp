	...
	<div id="featured">
		<ul class="ui-tabs-nav">
			<li class="ui-tabs-nav-item ui-tabs-selected" id="nav-fragment-1">
				<a href="#fragment-1">
					<img src="../imagens/Slider/destaque3p.jpg" alt="" />
					<span>Madeira do Horiente</span>
				</a>
			</li>
			<li class="ui-tabs-nav-item" id="nav-fragment-2">
				<a href="#fragment-2"><img src="../imagens/Slider/destaque2p.jpg" alt="" />
				<span>Creme de Barbatimão Chocolate e Menta</span>
				</a>
			</li>
			<li class="ui-tabs-nav-item" id="nav-fragment-3">
				<a href="#fragment-3"><img src="../imagens/Slider/destaque3p.jpg" alt="" />
					<span>Rodeio Driver colônia masculina</span>
				</a>
			</li>
			<li class="ui-tabs-nav-item" id="nav-fragment-4">
				<a href="#fragment-4"><img src="../imagens/Slider/destaque4p.jpg" alt="" />
					<span>Gel esfoliante facial com semente de maracujá</span>
				</a>
			</li>
		</ul>
		<!-- First Content -->
