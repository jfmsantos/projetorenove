					...
					<div class="content">
						<div class="submenu">
							<table cellpadding="5" cellspacing="5">
								<tr>
									<td>
										<a href="mostraCategoria?id=${categoria.id}">Voltar</a>
									</td>
								</tr>
							</table>
						</div>
						<form method="post" >
							<table class="form" cellpadding="5" cellspacing="5">
								<tr>
									<td>Nome</td>
									<td><input type="hidden" name="id" value="${categoria.id}"><input type="text" name="nome" value="${categoria.nome}"> ${erroNome}</td>
								</tr>
								<tr>
